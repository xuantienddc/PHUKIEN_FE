<template>
    ...
    <header>
        <div class="topbar d-flex align-items-center text-bg-warning">
            <nav class="navbar navbar-expand">
                <div class="topbar-logo-header ">
                    <div class="">
                        <img src="../../assets/images/cl.jpg" class="logo-icon" alt="logo icon">
                    </div>
                    <div class="">
                        <h4 class="logo-text">Linh Kiện Điện Thoại</h4>
                    </div>
                </div>
                <div class="mobile-toggle-menu"><i class='bx bx-menu'></i></div>
                <div class="search-bar flex-grow-1 ">
                    <div class="position-relative search-bar-box">
                        <input type="text" class="form-control search-control border border-black" placeholder="Tìm kiếm..."> <span
                ...
                <div class="user-box dropdown">
                    <a class="d-flex align-items-center nav-link dropdown-toggle dropdown-toggle-nocaret" href="#"
                        ...
                        <div class="user-info ps-3">
                            <p class="user-name mb-0">Đăng nhập</p>
