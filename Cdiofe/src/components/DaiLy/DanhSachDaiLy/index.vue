                                ...
                                <template v-for="(v, k) in list_dang_ky">
                                    <tr>
                                        ...
                                        <td class="align-middle text-nowrap text-center d-flex justify-content-around">
                                            <button @:click="Object.assign(update_dang_ky, v); is_view = 1" class='btn btn-primary' data-bs-toggle="modal"
                                    ...
                                    <div class="modal-dialog modal-lg">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                <button type="button" class="btn btn-secondary"
                                                    data-bs-dismiss="modal">Close</button>
                                                <button @:click="delDaiLy()" type="button" class="btn btn-primary"
...
export default {
    ...
    methods: {
        loadDangKy() {
            axios
                .get('http://127.0.0.1:8000/api/dai-ly/tao-tai-khoan/data')
                .then((res) => {
        ...
        accpectUpdate() {
            axios
                .put('http://127.0.0.1:8000/api/dai-ly/tao-tai-khoan/update', this.update_dang_ky)
                .then((res) => {
                    if (res.data.status) {
        ...
        delDaiLy() {
            axios
                .delete('http://127.0.0.1:8000/api/dai-ly/tao-tai-khoan/delete/' + this.delete_dang_ky.id)
                .then((res) => {
                    if (res.data.status) {
                        toaster.success('Thông báo<br>' + res.data.message);
                        this.loadDangKy();
